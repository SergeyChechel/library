...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    let offset = 0;
    let slideIndex = 0; // $(this[i].querySelector('.carousel-next')).on('click', (e) => {
    //     e.preventDefault();
    ...
    const bindTriggers = (triggerSelector, rotateDirection) => {
      Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i].querySelector(triggerSelector)).on('click', e => {
        e.preventDefault();
    ...
    bindTriggers('.carousel-next', 'right');
    bindTriggers('.carousel-prev', 'left');
...
Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])('.carousel').carousel(); // верстка создается в скрипте и вставляется на страницу (в div.carousel), иницаилизация слайдера в файле main.js
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    modal.classList.add('modal'); // console.log(this[i].getAttribute('data-target').slice(1));
...
//     </div>`
// );
// console.log($('.dropdown-toggle').eq(0));
